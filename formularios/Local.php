        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form action="CadastraLocal.php" method="POST">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Endereço</label>
                                    <input class="input--style-4" type="text" name="endereco" required>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                    ...
                                    <select class="input--style-4" type="select" name="medico" required>
                                        ...
                                        <?php
                                            $result_nome_medicos = "SELECT medicoId,nome FROM medico";
                                            $resultado = mysqli_query($conexao, $result_nome_medicos);
